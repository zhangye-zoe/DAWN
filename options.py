...
class Options:
    def __init__(self, isTrain):
        ...
        self.model['out_c'] = 1
        self.model["weight"] = {"encode loss": 0.1, "fuse prob loss": 0.15, "semi_sup loss": 0.01}
    ...
    def define_transforms(self):
        ...
        self.transform['train_stage1'] = {  # for the training of stage 1
            ...
            'label_gaussian': (-3, self.gaussian_sigma),
            'to_tensor': 2,
        ...
        self.transform['train_stage2'] = {  # for the training of stage 2
            ...
            'random_rotation': 90,
            'random_crop': self.train['input_size'],
            'label_gaussian': (-4, self.gaussian_sigma),
